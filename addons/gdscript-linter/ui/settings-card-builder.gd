...
func create_display_options_card(controls: Dictionary) -> GDLintCollapsibleCard:
	var card := GDLintCollapsibleCard.new(
		"Display Options",
		"code_quality/ui/display_options_collapsed",
	)
	...
	controls.show_ignored_check = _create_checkbox(
		"Show Ignored",
		hbox,
		"Show ignored issues in a separate section",
	)
	controls.show_full_path_check = _create_checkbox(
		"Show Full Path",
		hbox,
		"Show full res:// path instead of just filename",
	)
...
func create_export_options_card(controls: Dictionary) -> GDLintCollapsibleCard:
	var card := GDLintCollapsibleCard.new(
		"Export Options",
		"code_quality/ui/export_options_collapsed",
	)
	var vbox := card.get_content_container()
...
func create_limits_card(controls: Dictionary) -> GDLintCollapsibleCard:
	...
	controls.max_lines_soft_spin = _add_spin_row(
		grid,
		"File Lines (warn):",
		50,
		1000,
		DEFAULT_FILE_LINES_SOFT,
		DEFAULT_FILE_LINES_SOFT,
	)
	controls.max_lines_hard_spin = _add_spin_row(
		grid,
		"File Lines (crit):",
		100,
		2000,
		DEFAULT_FILE_LINES_HARD,
		DEFAULT_FILE_LINES_HARD,
	)

	# Row 2: Function lines / complexity warning
	controls.max_func_lines_spin = _add_spin_row(
		grid,
		"Func Lines:",
		10,
		200,
	...
	controls.max_complexity_spin = _add_spin_row(
		grid,
		"Complexity (warn):",
		5,
		50,
	...
	controls.func_lines_crit_spin = _add_spin_row(
		grid,
		"Func Lines (crit):",
		20,
		300,
		DEFAULT_FUNC_LINES_CRIT,
		DEFAULT_FUNC_LINES_CRIT,
	)
	controls.max_complexity_crit_spin = _add_spin_row(
		grid,
		"Complexity (crit):",
		5,
		50,
		DEFAULT_COMPLEXITY_CRIT,
		DEFAULT_COMPLEXITY_CRIT,
	)

	# Row 4: Max params / nesting
	controls.max_params_spin = _add_spin_row(
		grid,
		"Max Params:",
		2,
		15,
	...
	controls.max_nesting_spin = _add_spin_row(
		grid,
		"Max Nesting:",
		2,
		10,
	...
	controls.god_class_funcs_spin = _add_spin_row(
		grid,
		"God Class Funcs:",
		5,
		50,
		DEFAULT_GOD_CLASS_FUNCS,
		DEFAULT_GOD_CLASS_FUNCS,
	)
	controls.god_class_signals_spin = _add_spin_row(
		grid,
		"God Class Signals:",
		3,
		30,
		DEFAULT_GOD_CLASS_SIGNALS,
		DEFAULT_GOD_CLASS_SIGNALS,
	)
